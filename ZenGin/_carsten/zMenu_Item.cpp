...
zBOOL zCMenuItemInput::Run()	
{
	...
	Enter();	
		...
		// Hat sich der Wert geändert -> Optionswert schreiben
		if (inpText != oldText) 
		{
...
{
	// FontY() muss schon die Grösse des Views kennen, da die Grösse aber
	// in Abhängigkeit von FontY() ermittelt werden soll:
	// temporär dem Vater den aktuellen Font geben
