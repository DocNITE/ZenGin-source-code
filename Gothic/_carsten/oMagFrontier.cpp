...
{
	// [EDENFELD] Magische Barriere für 1.09 bzw. Gothic 2 deaktiviert
...
{
	{
		...
		zRELEASE(lightning); // [Moos] das Vob kümmert sich nun darum
	};
	...
	// add quadmark for collision point with world
	{
		...
		zRELEASE(quady);     // [Moos] das Vob kümmert sich nun darum
		zRELEASE(quadMat);
	}
};
