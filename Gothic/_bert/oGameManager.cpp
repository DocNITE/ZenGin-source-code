...
{
#ifndef _DEBUG
	// Verfallsdatum für EXE hier!
	//
	// Falls  2. EXE älter als 1,5 Tage (Systemdatum)
	//        1. Version heißt "...pre"
	//   Schreie laut auf!
...
{		
	...
	// Überprüfe, ob etwas anderes als ein Gamestart gewuenscht ist:
...
/* ----------------------------------------------------------------------
	...
	22.09.2000	[Moos]	
                erzeugt; quick-exit-routine für die Demo

   ---------------------------------------------------------------------- */

void emergency_exit(){
    zsound = NULL; // [Moos] Sonst: Crash, wenn das Soundsystem weg ist, aber noch sounds gelöscht werden...
...
{			
	...
	// Aktuell eingestellte Auflösung auslesen
...
{		
	...
	{		
		...
		// [BENDLIN] 1.30 eigentlich müßte zDeinitOptions aufgerufen werden
	...
	if (action == "NEW_GAME") 
	{
		...
		// Wenn Session vorher beendet, Flag zurücksetzen
		exitSession = FALSE;
...
zBOOL CGameManager::MenuEnabled(zBOOL& enableSave)
{
	...
	// [EDENFELD] neu 1.09 aus ModSource übertragen: npc-mode berücksichtigen
...
// FIXME: was anderes überlegen. Mehrere Welten parallel!!!
